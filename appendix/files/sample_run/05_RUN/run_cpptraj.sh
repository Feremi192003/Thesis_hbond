#!/bin/bash
#SBATCH --job-name="WT_iso10_cpptraj"
#SBATCH --output=traj_out
#SBATCH --error=traj_err
#SBATCH --partition=exx96
#SBATCH -B 1:1:1
#SBATCH -N 1
#SBATCH --mail-user=fcaballero@wesleyan.edu
...
cd "/zfshomes/fcaballero/isoformProject/new_wild_type_runs/rep3/iso10/05_PROD"
cpptraj -i combine_traj.in > combine.log
